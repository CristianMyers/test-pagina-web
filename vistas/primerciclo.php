...
<head>
    <meta charset="UTF-8">
    <title>Primer Ciclo - Registro de Ausentes</title>
    <link rel="stylesheet" href="http://localhost/sanviator_v2/css/primerciclo.css?<?php echo time(); ?>">
</head>
<body>
...
<!-- Contenido Principal -->
<div class="container">
    <h1>Primer Ciclo - Registro de Ausentes</h1>
