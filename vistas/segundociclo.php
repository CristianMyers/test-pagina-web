...
<head>
    <meta charset="UTF-8">
    <title>Segundo Ciclo - Registro de Ausentes</title>
    <link rel="stylesheet" href="http://localhost/sanviator_v2/css/segundociclo.css?<?php echo time(); ?>">
</head>
<body>
...
<!-- Contenido Principal -->
<div class="container">
    <h1>Segundo Ciclo - Registro de Ausentes</h1>
